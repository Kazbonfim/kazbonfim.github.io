    ...
    return (
        <div className='container text-center mt-3 position-relative'>
            ...
            <div className='row g-2 justify-content-center'>
                ...
                <div className='col-12 col-sm-6 col-md-3'>
                    <button className='uk-button uk-button-large uk-button-secondary w-100 fs-5' onClick={() => handleButton('#')} disabled><span className="uk-margin-small-right" uk-icon="cog"></span>Projetos</button>
                </div>
            </div>
