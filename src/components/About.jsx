        ...
        <div className='container mt-3 mb-3 rounded'>
            <div className='text-light shadow p-4' style={{ backgroundColor: 'rgba(20, 93, 176, 0.5)' }}>
                <ul uk-accordion="multiple: true">
                    ...
                    <li>
                        <a className="uk-accordion-title text-light" href="#">Contatos</a>
                        <div className="uk-accordion-content">
                            <p>
                                Estou <strong>aberto a propostas, colaborações e novas ideias</strong>. Acredito que, ao <em>compartilharmos conhecimento</em> e <em>desenvolvermos juntos</em>, conseguimos alcançar patamares ainda maiores.
                                Para entrar em contato, você pode usar meu <strong>WhatsApp profissional</strong>, redes sociais ou preencher o formulário abaixo.
                                <strong><a href="https://forms.gle/KGoseX26tpiu3cR69">Clique aqui para acessar o formulário de contato</a></strong> e <em>sinta-se à vontade para me chamar!</em>
                            </p>
                            <hr className="uk-divider-icon"></hr>
                        </div>
                    </li>
